...
import { CommentObject, PostObject, UserObject } from '../interfaces/ModelTypes'
...
const Posts: InferSchemaType<typeof postSchema> = mongoose.model('Posts', postSchema, 'posts')
...
const Comments: InferSchemaType<typeof commentSchema> = mongoose.model('Comments', commentSchema, 'comments')
...
const mySchemas: schemasObject = {'Users':Users, 'Posts':Posts, 'Comments': Comments}
